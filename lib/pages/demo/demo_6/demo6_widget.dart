...
class Demo6Widget extends StatefulWidget {
  const Demo6Widget({Key? key}) : super(key: key);
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Align(
                                alignment: AlignmentDirectional(0.0, 0.0),
                                child: Text(
                                  'Click on the 8 card since it is one greater than the bottom card!',
