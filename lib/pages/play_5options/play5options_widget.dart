...
class Play5optionsWidget extends StatefulWidget {
  const Play5optionsWidget({Key? key}) : super(key: key);
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          if (!FFAppState().answeredQuestion) {
                                            ...
                                            if (FFAppState().problemInfo.num4 ==
                                                FFAppState()
                                                    .problemInfo
                                                    .correctNum) {
                                              setState(() {
                                            ...
                                            children: [
                                              ClipRRect(
                                                borderRadius:
                                                    BorderRadius.circular(0.0),
                                                child: Image.asset(
                                                  'assets/images/card_${functions.convertSymbolicToDotNum(FFAppState().problemInfo.num4Symbolic)}${functions.convertValueToTwoDigit(FFAppState().problemInfo.num4)}.png',
                                                  width: 300.0,
                                                  height: 200.0,
                                                  fit: BoxFit.cover,
                                                ),
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          if (!FFAppState().answeredQuestion) {
                                            ...
                                            if (FFAppState().problemInfo.num5 ==
                                                FFAppState()
                                                    .problemInfo
                                                    .correctNum) {
                                              setState(() {
                                            ...
                                            children: [
                                              ClipRRect(
                                                borderRadius:
                                                    BorderRadius.circular(0.0),
                                                child: Image.asset(
                                                  'assets/images/card_${functions.convertSymbolicToDotNum(FFAppState().problemInfo.num5Symbolic)}${functions.convertValueToTwoDigit(FFAppState().problemInfo.num5)}.png',
                                                  width: 300.0,
                                                  height: 200.0,
                                                  fit: BoxFit.cover,
                                                ),
